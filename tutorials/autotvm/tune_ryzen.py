...
#target = tvm.target.create('llvm') # works on both local and remote
#target = tvm.target.create('opencl -device=radeon') # works on local Radeon machine, device_key = 'radeon'
target = tvm.target.create('vulkan')
#target = tvm.target.create('vulkan -device=ryzen')
...
device_key = 'ryzen' #'ryzen'

# Set this to True if you use android phone
use_android = False

#### TUNING OPTION ####
network = 'vgg-16' #"squeezenet_v1.0" #'mobilenet' #'resnet-50' #'inception_v3'
...
def tune_tasks(tasks,
    ...
    tasks = prune_old_tasks(tasks, tmp_log_file)
